...
const Sidebar: React.FC = () => {
  ...
  const navItems = [
    ...
    { name: "Driver Dashboard", path: "/dashboard/driver-dashboard", roles: ["PARKING_ATTENDANT"] },
    { name: "Users", path: "/dashboard/users", roles: ["ADMIN"] },
    { name: "Parking", path: "/dashboard/parking", roles: ["ADMIN", "PARKING_ATTENDANT"] },
    { name: "Car Records", path: "/dashboard/car-records", roles: ["ADMIN", "PARKING_ATTENDANT"] },
  ];
    ...
    <>
      ...
      >
        <div className="mb-8 text-center">
          ...
          <h1 className="font-bold text-xl">Parking System</h1>
        </div>
          ...
          {navItems
            ...
            .map((item) => (
              <NavLink
                ...
                to={item.path}
                className={({ isActive }) =>
                  `block px-5 py-3 rounded-md hover:bg-blue-200 ${
